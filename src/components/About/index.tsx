    ...
    <section className="flex flex-col justify-between">
      <div className="description">
        ...
        <p className="text-2xl text-gray-light my-6 leading-10">
          Fascinado pelo ecossistema JavaScript, atuo desenvolvendo software na <a href="https://www.zrp.com.br/" target="_blank" className="text-white underline underline-offset-1 text-zenith" rel="noreferrer">ZRP</a>, atualmente com as tecnologias: Javascript, Typescript, VueJS, React, Node, e NestJS.
        </p>
      </div>
